// ======================================================================
// PRACTICA 5.v generated from TopDesign.cysch
// 04/18/2023 at 03:11
...
// LED_Driver_v1_10(BrightnessCtrl=1, ClkSource=0, CommonDrive=1, InternalClockFrequency=204800, NumCom=4, NumSeg=7, RefreshRate=200, SegmentDrive=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=LED_Driver_v1_10, CY_CONFIG_TITLE=Segments, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Segments, CY_INSTANCE_SHORT_NAME=Segments, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Segments, )
...
// Counter_v3_0(CaptureMode=0, CaptureModeSoftware=0, ClockMode=0, CompareMode=1, CompareModeSoftware=0, CompareStatusEdgeSense=true, CompareValue=1, CONTROL3=1, ControlRegRemoved=0, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InitCounterValue=0, InterruptOnCapture=false, InterruptOnCompare=false, InterruptOnOverUnderFlow=false, InterruptOnTC=false, Period=23999, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, ReloadOnCapture=false, ReloadOnCompare=false, ReloadOnOverUnder=true, ReloadOnReset=true, Resolution=16, RunMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UseInterrupt=true, VerilogSectionReplacementString=sC16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Counter_v3_0, CY_CONFIG_TITLE=Contador, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Contador, CY_INSTANCE_SHORT_NAME=Contador, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Contador, )
...
module top ;
	...
	cy_clock_v1_0
		#(.id("aef19094-be99-430b-bd24-0ecb1fe35cbb"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__SW_vel_net;
	wire [0:0] tmpFB_0__SW_vel_net;
	wire [0:0] tmpIO_0__SW_vel_net;
	wire [0:0] tmpINTERRUPT_0__SW_vel_net;
	electrical [0:0] tmpSIOVREF__SW_vel_net;

	cy_psoc3_pins_v1_10
		#(.id("fc9d7adf-1228-4a22-881c-da0e541a5670"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SW_vel
		 (.oe(tmpOE__SW_vel_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW_vel_net[0:0]}),
		  .io({tmpIO_0__SW_vel_net[0:0]}),
		  .siovref(tmpSIOVREF__SW_vel_net),
		  .interrupt({tmpINTERRUPT_0__SW_vel_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW_vel_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    LED_Driver_v1_10_0 Segments (
        .clock(1'b0),
        .com(Net_8[3:0]),
        .seg(Net_7[6:0]));

    Counter_v3_0_1 Contador (
        .capture(1'b0),
        .clock(Net_12),
        .comp(Net_11),
        .count(1'b0),
        ...
        .up_ndown(1'b1),
        .upCnt(1'b0));
    defparam Contador.CaptureMode = 0;
    defparam Contador.ClockMode = 0;
    defparam Contador.CompareMode = 1;
    defparam Contador.CompareStatusEdgeSense = 1;
    defparam Contador.EnableMode = 0;
    defparam Contador.ReloadOnCapture = 0;
    defparam Contador.ReloadOnCompare = 0;
    defparam Contador.ReloadOnOverUnder = 1;
    defparam Contador.ReloadOnReset = 1;
    defparam Contador.Resolution = 16;
    defparam Contador.RunMode = 0;
    defparam Contador.UseInterrupt = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("9aa2bf61-4450-49de-980d-9efead7aadde"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LEDS_net;
	wire [0:0] tmpFB_0__LEDS_net;
	wire [0:0] tmpIO_0__LEDS_net;
	...
	cy_psoc3_pins_v1_10
		...
		LEDS
		 (.oe(tmpOE__LEDS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LEDS_net[0:0]}),
		  .io({tmpIO_0__LEDS_net[0:0]}),
	...
	assign tmpOE__LEDS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SW_buzz_net;
	wire [0:0] tmpFB_0__SW_buzz_net;
	wire [0:0] tmpIO_0__SW_buzz_net;
	wire [0:0] tmpINTERRUPT_0__SW_buzz_net;
	electrical [0:0] tmpSIOVREF__SW_buzz_net;

	cy_psoc3_pins_v1_10
		#(.id("47c6c3ef-44ae-4503-9887-c4fdfaa8a30d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SW_buzz
		 (.oe(tmpOE__SW_buzz_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW_buzz_net[0:0]}),
		  .io({tmpIO_0__SW_buzz_net[0:0]}),
		  .siovref(tmpSIOVREF__SW_buzz_net),
		  .interrupt({tmpINTERRUPT_0__SW_buzz_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW_buzz_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("0d198296-e458-42c2-8493-9656f4a0243b"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bcd585e7-6eb7-471d-b0b7-1b2c4246ebe7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__DosP_net;
	wire [0:0] tmpFB_0__DosP_net;
	wire [0:0] tmpIO_0__DosP_net;
	wire [0:0] tmpINTERRUPT_0__DosP_net;
	electrical [0:0] tmpSIOVREF__DosP_net;

	cy_psoc3_pins_v1_10
		#(.id("03cc7824-7244-4e06-ac00-7525a765f737"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		DosP
		 (.oe(tmpOE__DosP_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DosP_net[0:0]}),
		  .io({tmpIO_0__DosP_net[0:0]}),
		  .siovref(tmpSIOVREF__DosP_net),
		  .interrupt({tmpINTERRUPT_0__DosP_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DosP_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
