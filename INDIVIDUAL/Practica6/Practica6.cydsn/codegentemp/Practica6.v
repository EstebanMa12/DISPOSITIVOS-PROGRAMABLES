// ======================================================================
// Practica6.v generated from TopDesign.cysch
// 04/28/2023 at 23:35
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d07732fc-1914-488c-8c84-78685d4c347e/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_v3_10_1 (
	...
	cy_clock_v1_0
		#(.id("eed4f0fc-93c8-44a9-88f8-4d36a76cb3de/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__Peso_net;
	wire [0:0] tmpFB_0__Peso_net;
	wire [0:0] tmpIO_0__Peso_net;
	wire [0:0] tmpINTERRUPT_0__Peso_net;
	electrical [0:0] tmpSIOVREF__Peso_net;

	cy_psoc3_pins_v1_10
		#(.id("13e141f0-a2a1-491c-8df7-614af56a8318"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Peso
		 (.oe(tmpOE__Peso_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Peso_net[0:0]}),
		  .analog({Net_52}),
		  .io({tmpIO_0__Peso_net[0:0]}),
		  .siovref(tmpSIOVREF__Peso_net),
		  .interrupt({tmpINTERRUPT_0__Peso_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Peso_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__clavecorrecta_net;
	wire [0:0] tmpFB_0__clavecorrecta_net;
	wire [0:0] tmpIO_0__clavecorrecta_net;
	wire [0:0] tmpINTERRUPT_0__clavecorrecta_net;
	electrical [0:0] tmpSIOVREF__clavecorrecta_net;

	cy_psoc3_pins_v1_10
		#(.id("8716a79c-b205-4a62-8115-f41a742f23d5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		clavecorrecta
		 (.oe(tmpOE__clavecorrecta_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__clavecorrecta_net[0:0]}),
		  .io({tmpIO_0__clavecorrecta_net[0:0]}),
		  .siovref(tmpSIOVREF__clavecorrecta_net),
		  .interrupt({tmpINTERRUPT_0__clavecorrecta_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__clavecorrecta_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("da0139b4-df50-481a-bf8c-bda98e1a11bb"),
		  .source_clock_id(""),
		  .divisor(0),
