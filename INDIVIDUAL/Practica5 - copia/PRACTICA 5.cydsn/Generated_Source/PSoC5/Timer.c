...
void Timer_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)Timer__INTC_NUMBER] = address;
}
...
cyisraddress Timer_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)Timer__INTC_NUMBER];
}
