...
module top ;
    ...
    begin : LUT_1
        ...
        assign tmp__LUT_1_ins = {Q2,Q1,Q0};
        always @(tmp__LUT_1_ins)
        begin
            case (tmp__LUT_1_ins)
                3'b000 :  tmp__LUT_1_reg = 7'b0110001;
                3'b001 :  tmp__LUT_1_reg = 7'b0101011;
                3'b010 :  tmp__LUT_1_reg = 7'b0111110;
                3'b011 :  tmp__LUT_1_reg = 7'b1001001;
                3'b100 :  tmp__LUT_1_reg = 7'b1110010;
                3'b101 :  tmp__LUT_1_reg = 7'b1010000;
                3'b110 :  tmp__LUT_1_reg = 7'b0011111;
                3'b111 :  tmp__LUT_1_reg = 7'b1010010;
            endcase
        end
        assign {Net_21,Net_20,Net_19,Net_18,Net_17,Net_16,Net_15} = tmp__LUT_1_reg;
    end
    // -- LUT LUT_1 end --
	...
	cy_psoc3_pins_v1_10
		#(.id("6da72e43-f830-4edb-b86c-eaa4cc349967"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fe661f6a-d738-4dbb-868e-7fe472fe3e3f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4bb10f98-40e2-467e-b3ec-153bfe1202d5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e851bd2c-058f-4759-bfd6-d7f697b148f7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("50fb3719-7938-4e13-b705-85dd66b49204"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bd9910b7-a079-4133-9c6e-c562082cbc5d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("bd315b9e-0b6e-4954-9ee8-9ef2773ba719"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__BOT1_net;
	wire [0:0] tmpIO_0__BOT1_net;
	wire [0:0] tmpINTERRUPT_0__BOT1_net;
	electrical [0:0] tmpSIOVREF__BOT1_net;
	...
	cy_psoc3_pins_v1_10
		...
		BOT1
		 (.oe(tmpOE__BOT1_net),
		  .y({1'b0}),
		  .fb({Net_392}),
		  .io({tmpIO_0__BOT1_net[0:0]}),
		  .siovref(tmpSIOVREF__BOT1_net),
		  .interrupt({tmpINTERRUPT_0__BOT1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BOT1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SWITCHE_net;
	wire [0:0] tmpIO_0__SWITCHE_net;
	wire [0:0] tmpINTERRUPT_0__SWITCHE_net;
	electrical [0:0] tmpSIOVREF__SWITCHE_net;

	cy_psoc3_pins_v1_10
		#(.id("457cdfb9-7a63-46e0-9640-a906adfbd4a3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SWITCHE
		 (.oe(tmpOE__SWITCHE_net),
		  .y({1'b0}),
		  .fb({X}),
		  .io({tmpIO_0__SWITCHE_net[0:0]}),
		  .siovref(tmpSIOVREF__SWITCHE_net),
		  .interrupt({tmpINTERRUPT_0__SWITCHE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SWITCHE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    assign Net_73 = Q0N & Q1 & Q2;


    assign Net_76 = Q0N & XN;


    assign Net_77 = XN & Q1;


    assign D0 = Net_73 | Net_74 | Net_76 | Net_77;


    assign Net_114 = XN & Q0N & Q1 & Q2N;


    assign Net_115 = X & Q0N & Q1 & Q2;


    assign Net_117 = X & Q1N & Q0;


    assign Net_118 = Q1N & Q0 & Q2;


    assign D1 = Net_114 | Net_115 | Net_117 | Net_118;


    assign Net_74 = XN & Q2N;


    assign Net_137 = X & Q0N & Q1 & Q2;


    assign Net_138 = X & Q0 & Q1 & Q2N;


    assign Net_140 = XN & Q1N & Q2;


    assign D2 = Net_137 | Net_138 | Net_140;

    // -- LUT LUT_2 start --
    if (1)
    begin : LUT_2
        reg [7:0] tmp__LUT_2_reg;
        wire [2:0] tmp__LUT_2_ins;
        assign tmp__LUT_2_ins = {Q2,Q1,Q0};
        always @(tmp__LUT_2_ins)
        begin
            case (tmp__LUT_2_ins)
                3'b000 :  tmp__LUT_2_reg = 8'b10000001;
                3'b001 :  tmp__LUT_2_reg = 8'b01000010;
                3'b010 :  tmp__LUT_2_reg = 8'b00100100;
                3'b011 :  tmp__LUT_2_reg = 8'b11100111;
                3'b100 :  tmp__LUT_2_reg = 8'b00011000;
                3'b101 :  tmp__LUT_2_reg = 8'b01100110;
                3'b110 :  tmp__LUT_2_reg = 8'b01010101;
                3'b111 :  tmp__LUT_2_reg = 8'b11111111;
            endcase
        end
        assign {Net_34,Net_32,Net_31,Net_30,Net_29,Net_28,Net_27,Net_26} = tmp__LUT_2_reg;
    end
    // -- LUT LUT_2 end --
	...
	cy_psoc3_pins_v1_10
		#(.id("5ebbae90-442c-4168-8caa-0e826d690148"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("15fb862f-e76c-4d8f-ad91-ebbbbab345d6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1b35e87b-3a02-4ad2-91dd-c4d6a77f7e30"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("724f5ed0-52eb-45d9-8ae7-3692e24ddec4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a8b9bd8d-76fe-4994-84f0-62651605a3ef"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("31282c1d-b817-4789-9411-214f21f3de5a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6affa22a-f6c9-4e03-b6b0-3a23629614c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2ecb01dc-f3e0-4487-9916-9eaa72bf3f4b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Z0 = Net_37 | Net_38 | Net_40;


    assign Net_37 = Q0 & Q2N & Q1;


    assign Net_38 = Q2 & Q0N;


    assign Net_40 = Q2 & Q1N;
	...
	cy_psoc3_pins_v1_10
		#(.id("9e014962-72f6-47fb-a2d6-990de6e65d89"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("56d08d5b-db2e-44f2-961c-2f0229c98256"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
